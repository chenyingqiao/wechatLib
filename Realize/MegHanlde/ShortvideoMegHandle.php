...
*/
class ShortvideoMegHandle extends MegHandle implements IMegHandle
{
	//规定消息的类型
	const MEG_TYPE="shortvideo";
	//消息链条配置循序
	 ...
	 * @return [type]          [返回xml]
	 */
	public function createMessge($MediaId,$Description,$Title,$messge){
		return "";
	}
}